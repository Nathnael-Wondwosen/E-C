export const STATIC_NAVBAR_LINKS = [
  ...
  { id: 'global-market', title: 'Global Market', url: '/marketplace', type: 'internal', enabled: true, order: 6 },
  { id: 'africa-market', title: 'Africa Market', url: '/markets/africa', type: 'internal', enabled: true, order: 7 },
  { id: 'china-market', title: 'China Market', url: '/markets/china', type: 'internal', enabled: true, order: 8 },
  { id: 'b2b-marketplace', title: 'B2B Market', url: '/markets/b2b', type: 'internal', enabled: true, order: 9 },
  { id: 'blog', title: 'Blog', url: '/blog', type: 'internal', enabled: true, order: 10 },
];
