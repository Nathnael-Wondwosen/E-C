            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-4 mb-4 border border-blue-100">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center justify-between py-1">
                  ...
                  <span className={`font-medium px-2 py-1 rounded-full text-xs ${product.postAs === 'buyer' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'}`}>
                ...
                <div className="flex items-center justify-between py-1">
                  ...
                  <span className="font-medium text-gray-800">{product.quantity || product.stock || 0} {product.unit || 'units'}</span>
                </div>
                ...
                {product.qualityGrade && (
                  <div className="flex items-center justify-between py-1">
                    ...
                    <span className="font-medium text-gray-800">{product.qualityGrade}</span>
                  </div>
                )}
                ...
                {product.phone && (
                  <div className="flex items-center justify-between py-1">
                    ...
                    <span className="font-medium text-gray-800">{product.phone}</span>
                  </div>
                )}
                ...
                {product.email && (
                  <div className="flex items-center justify-between py-1">
                    ...
                    <span className="font-medium text-gray-800">{product.email}</span>
                  </div>
                )}
                ...
                {product.moq && (
                  <div className="flex items-center justify-between py-1">
                    ...
                    <span className="font-medium text-gray-800">{product.moq} units</span>
                  </div>
                )}
                ...
                {product.leadTime !== undefined && (
                  <div className="flex items-center justify-between py-1">
                    ...
                    <span className="font-medium text-gray-800">{product.leadTime} days</span>
                  </div>
                )}
              </div>
            </div>
