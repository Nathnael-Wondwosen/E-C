...
export default function ExpoPage() {
  return (
    <>
      <Head>
        <title>Expo | TradeEthiopia</title>
      </Head>
      <main className="min-h-screen bg-slate-50 px-6 py-16 text-slate-900">
        <div className="mx-auto max-w-3xl rounded-2xl border border-slate-200 bg-white p-8">
          <h1 className="text-3xl font-extrabold">Expo</h1>
          <p className="mt-4 text-slate-600">
            Expo experience is ready. Continue building module-specific sections from this route.
          </p>
