  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center p-4">
      <Head>
        ...
        <meta name="description" content="Create your customer portal account" />
      </Head>

      <div className="w-full max-w-6xl">
        <div className="flex flex-col lg:flex-row bg-white rounded-none shadow-none overflow-hidden">
          {/* Left side - Image */}
          <div className="lg:w-2/5 bg-gradient-to-br from-blue-700 via-blue-800 to-indigo-900 flex items-center justify-center p-8">
            <div className="text-center max-w-lg">
              ...
              <h2 className="text-2xl font-bold text-white mb-3">Join Our Marketplace</h2>
              <p className="text-blue-200">Create an account to start shopping or selling with us</p>
            </div>
          </div>
          ...
          <div className="lg:w-3/5 p-8">
            <div className="max-w-lg mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="mt-1 text-gray-600">Join our marketplace today</p>
              </div>
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      type="button"
                      className={`py-2 px-3 rounded-none text-sm font-medium ${
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="text"
                        required
                        className="block w-full pl-8 pr-2 py-2 border border-gray-300 rounded-none bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        name="businessType"
                        required
                        className="block w-full pl-2 pr-8 py-2 border border-gray-300 rounded-none bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="block w-full pl-8 pr-8 py-2 border border-gray-300 rounded-none bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      ...
                      >
                        <svg className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          {showPassword ? (
                            <path key="eye-open" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                           ) : (
                            <g key="eye-closed">
                ...
                <div>
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full flex justify-center py-3 px-4 border border-transparent rounded-none shadow-none text-base font-medium text-white ${
                      loading 
